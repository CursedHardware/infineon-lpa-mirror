...
public class AuthenticateClientOkEs11 implements BerType, Serializable {
	...
	public static class EventEntries implements BerType, Serializable {
		...
		private List<com.gsma.sgp.messages.rspdefinitions.EventEntries> seqOf = null;

		public EventEntries() {
			seqOf = new ArrayList<com.gsma.sgp.messages.rspdefinitions.EventEntries>();
		}
		...
		public List<com.gsma.sgp.messages.rspdefinitions.EventEntries> getEventEntries() {
			if (seqOf == null) {
				seqOf = new ArrayList<com.gsma.sgp.messages.rspdefinitions.EventEntries>();
			}
			return seqOf;
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			while (subCodeLength < totalLength) {
				com.gsma.sgp.messages.rspdefinitions.EventEntries element = new com.gsma.sgp.messages.rspdefinitions.EventEntries();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (seqOf == null) {
				...
				Iterator<com.gsma.sgp.messages.rspdefinitions.EventEntries> it = seqOf.iterator();
				if (it.hasNext()) {
